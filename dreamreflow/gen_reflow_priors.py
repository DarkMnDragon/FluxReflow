...
def main(args):
    ...
    for epoch in range(args.num_epochs):
        ...
        for batch in dataloader:
            ...
            }, output_prompt_dir / f"prompt_{step:05d}.pt")
            ...
            torch.save(noise.detach().clone().cpu(), output_z_0_dir / f"z_0_{step:05d}.pt")
            ...
            torch.save(img_latents.detach().clone().cpu(), output_z_1_dir / f"z_1_{step:05d}.pt")

            imgs = decode_imgs(img_latents, vae, pipeline)[0]
            imgs.save(output_img_dir / f"img_{step:05d}.png")
